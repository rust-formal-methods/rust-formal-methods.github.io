...
All participants in the Rust Formal Methods IG meeting are expected to observe the [Rust code of conduct](https://www.rust-lang.org/policies/code-of-conduct).
...
Please observe the [meeting rules for participation](./meetings.md#rules-for-participation).
